...
class Settings:
    ...
    # Email cashback mailing via Resend API
    resend_api_key: str | None = None
    email_from: str = "clinic@policlinica24.ru"
...
def get_settings() -> Settings:
    ...
    email_from = os.getenv("EMAIL_FROM", "clinic@policlinica24.ru").strip() or "clinic@policlinica24.ru"
